...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend Course", "This project is developed by Sunita", "1.0",
				"Terms of Service", new Contact("Sunita", "", "sunitadangat271292@gmail.com"), "License of APIS",
